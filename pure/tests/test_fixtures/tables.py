...
TABLES1 = {
    ...
    "big_table": pd.DataFrame(
        np.random.choice(values, size=10_000, replace=True), columns=["revenue"]
    ),
}
...
TABLES2 = {
    ...
    "sales": pd.DataFrame(
        [
            ["2022-10-21", 100, None, 120.0, 500.0],
            ["2022-10-21", 100, 6, 120.0, 720.0],
            ["2022-10-21", 200, 2, 200.0, 400.0],
            ["2022-10-22", 300, None, 85.0, 850.0],
            ["2022-10-22", 100, 3, 110.0, 330.0],
            ["2022-10-22", 200, None, 200.0, 1600.0],
            ["2022-10-23", 300, 0, 90.0, 0.0],
            ["2022-10-23", 100, 5, 120.0, 500.0],
            ["2022-10-23", 100, 6, 120.0, 720.0],
            ["2022-10-23", 200, 2, 200.0, 400.0],
            ["2022-10-23", 300, None, 85.0, 850.0],
            ["2022-10-27", 100, 3, 110.0, 33.0],
            ["2022-10-27", 200, 8, 200.0, 160.0],
            ["2022-10-27", 300, 0, 90.0, 0.0],
            ["2022-10-27", 100, None, 120.0, 500.0],
            ["2022-10-28", 100, 6, 120.0, 720.0],
            ["2022-10-29", 200, 2, 200.0, 400.0],
            ["2022-10-29", 300, None, 85.0, 850.0],
            ["2022-10-29", 100, 3, 110.0, 330.0],
            ["2022-10-30", 200, 8, 0.0, 160.0],
            ["2022-10-31", 300, 1, 0.0, 1000.0],
        ],
        columns=["day", "item_id", "qty", "price", "revenue"],
    ),
    # Table with clickstream
